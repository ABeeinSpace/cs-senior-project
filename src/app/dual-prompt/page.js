	...
	return (
		...
		<div>
			...
			<div style={{
				...
				<p />
				<p>
					Please determine if the following code snippets, written in response to the given promts, was generated by a human or by an AI. 
				</p>
				<p>
					Note: Please base your guess based on who you believe the generators to be, and not based on the functionality of the code itself.
				</p>
