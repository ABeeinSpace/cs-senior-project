  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <p />
        <p>
          We decided to pursue this project after hearing about the development of OpenAI&#39;s ChatGPT, especially after it was learned that the program has the ability to
          generate human-like responses to prompts and questions, including the generation of code.
          While there are many positive applications of ChatGPT, one potential negative application that schools are particularly worried about is the
          possible usage of the software to commit academic dishonesty. In order to combat academic dishonesty, many teachers and professors are having to find ways of
        ...
        <p />
        <p>
          2. Are professors more successful at identifying AI-generated works than a student?
        </p>
        <p />
        <p>
          We decided to have users analyze code snippets rather than other types of generated content due to the fact that we, as computer science students,
          have greater access to human-generated code and coding prompts than other types of generated content. We would like to remind our users to grade the code
